...
/* データベース設定 */
define('DB_DNS', 'mysql:host=localhost; dbname=kakeibo; charset=utf8');
define('DB_USER', 'root');
...
<head>
  ...
  <!-- 追加・削除ボタンの制御 -->
  <script type="text/javascript" src="kakeibo_js2.js"></script>
</head>
<body>
<div id="wrapper">
<div id="input_form">
  <!-- POSTを使ってデータを渡す -->
  <form action="kakeibo_try8.php" method="POST">
    <table>
    ...
    <!-- inputタグで画面遷移ボタンを作成 -->
    <input type="button" onclick="location.href='kakeibo_try7-4.php'" value="集計">
    </p>
  </form>
  <!-- formの外でも動くようだ -->
  <!-- <input type="button" onclick="location.href='test.php'" value="遷移"> -->
  <!-- bottonタグで画面遷移ボタンを作成 -->
  <!-- <button onclick="location.href='test.php'">遷移</button> -->
  <!-- 直前のページに戻る（buttonを使用した版） -->
...
<table border='1'>
<!-- カラム名を表示する -->
<tr><td>id</td><td>日付</td><td>もらったお金</td><td>使ったお金</td><td>買ったもの</td><td>合計金額</td></tr>
...
<tr>
  ...
  <td>
		<form action="kakeibo_try7-3.php" method="post">
		<input type="submit" value="編集する">
		<input type="hidden" name="id" value="<?php echo $row['id'];?>">
		</form>
	</td>
  <td>
		<form action="kakeibo_try7-2.php" method="post">
